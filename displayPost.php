...
$val = $_POST['filterVal'];
$g = "select * from post LIMIT $newCount";

if($val == 'By Price Low to High'){
$g = "select * from post  ORDER BY price ASC LIMIT $newCount";
}else if($val == 'By Price High to Low'){
    $g = "select * from post  ORDER BY price DESC LIMIT $newCount";

}else if($val == 'By Date'){
    $g = "select * from post  ORDER BY date ASC LIMIT $newCount";
